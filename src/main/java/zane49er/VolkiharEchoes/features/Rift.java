...
public class Rift extends Block{
	...
	public Item getItemDropped(IBlockState state,Random rand,int amount) {
		//super.getItemDropped(state, rand, amount);
	...
	public int getFlammability(IBlockAccess p_getFlammability_1_, BlockPos p_getFlammability_2_, EnumFacing p_getFlammability_3_) {
		// TODO Auto-generated method stub
		//return super.getFlammability(p_getFlammability_1_, p_getFlammability_2_, p_getFlammability_3_);
		return 0;
	}
	
	@Override
	public boolean canCreatureSpawn(IBlockState p_canCreatureSpawn_1_, IBlockAccess p_canCreatureSpawn_2_, BlockPos p_canCreatureSpawn_3_, SpawnPlacementType p_canCreatureSpawn_4_) {
		// TODO Auto-generated method stub
		return super.canCreatureSpawn(p_canCreatureSpawn_1_, p_canCreatureSpawn_2_, p_canCreatureSpawn_3_, p_canCreatureSpawn_4_);
	}
	...
	public AxisAlignedBB getBoundingBox(IBlockState p_getBoundingBox_1_, IBlockAccess p_getBoundingBox_2_, BlockPos p_getBoundingBox_3_) {
		// TODO Auto-generated method stub
		return super.getBoundingBox(p_getBoundingBox_1_, p_getBoundingBox_2_, p_getBoundingBox_3_);
	}*/
